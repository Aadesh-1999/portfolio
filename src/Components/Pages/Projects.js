...
export const Projects = () => {
    return (
        <div className='m-5 p-5 d-flex justify-content-center'>
            <div className="title">
                <h1 className=' d-flex justify-content-center'>My&nbsp;<span>Recent Works</span></h1><br />
                <h3  className=' d-flex justify-content-center'>Few of my personal HTML, CSS, JavaScript, BootStrap & ReactJS Projects.</h3>
                <div className="projects my-5 row  d-flex justify-content-center">
